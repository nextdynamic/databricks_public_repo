...
# MAGIC 
# MAGIC val connectionString = "Endpoint=sb://gsethi-ehubs.servicebus.windows.net/;SharedAccessKeyName=default;SharedAccessKey=6qfjhOjwD3Kn8pQW7HWjKf2f2j+mqqxXp2azYpgeEnw=;EntityPath=ehubdatabricksintegration"
# MAGIC 
